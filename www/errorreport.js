...
var appVersion = '1.0.0 (2016)',
    reportBaseUrl= 'http://prototype.moodle.net/mobile/feedback/mmfeedback.php',
...
window.onerror = function(msg, url, lineNumber) {
    try {
        ...
        function reportError() {
            if (!errorReported) {
                errorReported = true;
                var reportUrl = reportBaseUrl + '?message=' + encodeURIComponent(msg) + '&file=' + encodeURIComponent(url) + '&line=' + encodeURIComponent(lineNumber) + '&appv=' + encodeURIComponent(appVersion) + '&bg=' + (reportInBackground ? 1 : 0);
